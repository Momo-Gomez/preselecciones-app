    ...
    <div className="s-container">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <button
          ...
          class="form-btn btn btn-primary me-md-2"
          type="button"
        >
          Hacer Trámite
        </button>
      ...
      <div class="card mb-5 shadow bg-body rounded">
        ...
        <div class="card-body">
          ...
          <p class="card-text ">
            Obras de carácter estructural de instalaciones (sanitarias,
            eléctricas o gas), reparación de la envolvente (techumbre), y de
            mantención (terminaciones, revestimientos, ventanas, puertas,
            pinturas, cierros, entre otros).
          </p>
          <h5 class="card-title">Ampliación de la vivienda</h5>
          <p class="card-text ">
            Obras destinadas aumentar la superficie de la vivienda existente
            para resolver problemas sanitarios o de hacinamiento. Por ejemplo,
            construcción de un nuevo baño, dormitorio o cocina.
          </p>
        </div>
      </div>
      ...
      <div class="card mb-5 shadow bg-body rounded">
        ...
        <div class="card-body">
          <p class="card-text">
            Este subsidio del Estado permite construir una vivienda en el
            terreno donde vive la familia interesada y se puede postular de
      ...
      <div class="card mb-5 shadow bg-body rounded">
        ...
        <div class="card-body">
          <p class="card-text">
            Este apoyo del Estado permite a las familias que no son dueñas de
      ...
      <div class="card mb-5 shadow bg-body rounded">
        ...
        <div class="card-body">
          <p class="card-text">
            Este apoyo del Estado permite construir una vivienda o un conjunto
